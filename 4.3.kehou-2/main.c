...
#define __NR_mysignal	48	/* wyj, 3 lines */
__always_inline _syscall1(int,alarm,int,sec)	
__always_inline _syscall2(int,mysignal,int,signr,void *,handler)
